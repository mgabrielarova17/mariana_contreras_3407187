...
Nombre de la entidad principal de tu dominio (string)
Identificador o código único (string o number)
Descripción o categoría (string)
Al menos un dato numérico relevante al dominio (number)
Al menos dos valores boolean que representen estados de la entidad
Una expresión aritmética calculada (ej: precio con descuento, total, capacidad restante)
Una sección de resumen del dominio
Requisitos técnicos
...
=========================================
DELIVERY EXPRESS - ORDEN #8823
INFORMACIÓN GENERAL
Nombre: Pizza Especial Familiar
Código: DEL-8823-X
Categoría: Comida Italiana - Prioritaria
Estado: En camino

DETALLES
Costo Comida: 18000
Total a Pagar: 20500
Repartidor Asignado: true
Pago Verificado: false

RESUMEN DEL DOMINIO
Dominio: App de Delivery
Entidad: Orden de Reparto
Total registros: 150

=========================================
¡Entrega rápida y segura con Node.js!
text
...
➡️ Semana 2: Variables y Tipos de Datos